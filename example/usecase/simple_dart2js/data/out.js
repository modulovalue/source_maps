...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      A.print("Hello");
      A.print("date " + new A.DateTime(Date.now(), false).toString$0(0));
    }
  },
  J = {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.Rti, A._FunctionParameters, A.DateTime, A.Null, A.StringBuffer]);
